            ...
            <div class="card rounded shadow-sm border-0">
                <div class="card-body p-0">
                    <div class="bg-primary px-5 py-4 text-center card-img-top"><img src={Dp} alt="..." width="100" class="rounded-circle mb-2 img-thumbnail d-block mx-auto"></img>
                        <h5 class="text-white mb-0">Tanuj Pancholi</h5>
                    ...
                    <div class="p-4 d-flex justify-content-center">
                        <ul class="list-inline mb-0">
                            <li class="list-inline-item">
                                ...
                                <a href="https://github.com/tanuj-22"><i class="fa fa-github mr-1 text-primary"></i></a></small>
                            </li>
                            <li class="list-inline-item">
                               <small class="text-muted"><a href="https://www.linkedin.com/in/tanuj-pancholi-ts-220869/"><i class="fa fa-linkedin mr-1 text-primary"></i></a></small>
                            </li>
                        </ul>
                    </div>
                </div>
